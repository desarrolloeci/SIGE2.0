                                                    ...
                                                    <div  style="height:200px;width: 99%; overflow-y: auto;">
                                                        <%
                                                            for (HashMap programa: programas) {
                                                                if(!programa.get("nom_prog").equals("INGENIERÍA AMBIENTAL")){ // Se eliminar la opción de ing ambiental temporalmente por correo de Andrés Pinzon - para volver solo se elimina el if de esta linea
                                                        %>
