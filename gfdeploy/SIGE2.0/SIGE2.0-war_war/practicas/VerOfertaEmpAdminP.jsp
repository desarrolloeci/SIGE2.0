            ...
            <tr class="textocom" style="background: #FFFFFF;">
                <td align="left">
                    ...
                    <tr>
                        ...
                        <td align="left"><input type="text" name="ofex" Style="width: 100px; font-family: Verdana,Arial,Helvetica,sans-serif; font-size: 12px; background-color: #EEEBFC;"> (Carn&eacute; Estudiante Ej. 9585588)</td>
                    </tr>
                    <%if(numa>0){%>
                    ...
                    <tr>
                        <td  colspan="2">
                            <div align="center"><input class="button_azul" type="submit" onclick="window.close()" value="Cerrar" /></div>
                        </td>
                    </tr>
                </table>
                    </form>
