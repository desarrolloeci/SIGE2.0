...
<html>
    <head>
        ...
        <%
            ...
            session.setAttribute("id_est", idest);
                            ...
                            <td valign="top" height="500" class="textocom" style="background: #FFFFFF;">
                                       ...
                                       <form name="fromDatGeneralesPrac" action="" method="POST">
                                          <table width="99%" >
                                            ...
                                            <tr>
                                              <td align="left" >Tel. de Residencia:</td>
                                             <td align="left" ><%=datos.get("tel_corr")%></td>
                                            </tr>
                                            <tr>
                                              <td align="left" >Telefono 2:</td>
                                              <td align="left" ><input class="inputgraduado"  name="tel2prac" id="tel2prac" type="text" size="20" maxlength="50" value="<%=datosprac.get("tel2")%>"></td>
                                            </tr>

                                            <tr>
                                              <td align="left" >Numero de Celular:</td>
                                              <td align="left" ><input class="inputgraduado"  name="celprac" id="celprac" type="text" size="20" maxlength="50" value="<%=datosprac.get("cel")%>" ></td>
                                            </tr>                                           
                                            <tr>
