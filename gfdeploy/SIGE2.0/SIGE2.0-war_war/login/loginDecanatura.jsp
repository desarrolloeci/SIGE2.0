    ...
    <head>
        ...
        <script type="text/javascript" language="javascript">
            ...
            window.onload = function() {
                ...
                selectSystem = document.getElementById('sistemaDec');
                txtUsr.focus();
            }
            ...
            function makeRequest(url) {
                ...
                url = url + "usuario=" + document.getElementById("usuario").value + "&clave=" +encodeURIComponent(document.getElementById("clave").value)+"&tipo=Decanatura&sistema="+document.getElementById("sistemaDec").value;
                //alert(url);
            ...
            function alertContents() {
                ...
                if (root_node.firstChild.data != "OK") {
                    ...
                    if (document.getElementById("sistemaDec").value=="movilidad") {
        ...
        <table width="450" align="center" class="curvas loginPanel" cellspacing="10">
            ...
            <tr>
                <td colspan="2" align="center">
                    <select name="sistemaDec" id="sistemaDec" class="textocom">
            ...
            <tr>   
                <td colspan="2" align="center">
                    <input id="btnLogIn" class="button_azul" type="submit" onclick="makeRequest('LoginSige?');" value="Conectar" />
                </td>
            </tr>
            <tr>
                <td colspan="2" align="center">                             
