...
<html>
    ...
    <%
        ...
        doc_grad = request.getParameter("id_est");
                            ...
                            <td align="center"valign="top" height="500" class="textocom">
                                <div align="center" id="ActDatos" style="display:inline">
                                    <form action="ActDatosEgre2" method="Post">
                                        <input type="hidden" name="docegre" value="<%=doc_grad%>">
                                    ...
                                    <table width="99%">
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                <select class="inputlargo" id="pais_res" name="pais_res" onchange="ver();">
                                                    <%
                                                        for (HashMap paisItem : paises) {
                                                            String nomPais = (String) paisItem.get("nom_pai");
                                                    %>
                                                            <option value="<%=paisItem.get("cod_pai")%>"<%=nomPais.equalsIgnoreCase((String) datos.get("pais_residencia"))?" selected":""%>><%=nomPais%></option>
                                                    <%
                                                        }
                                                    %>
                                                </select>
                                        ...
                                        <tr>
                                            ...
                                            <td align="left">
                                                ...
                                                -<input class="inputmediano" name="tel_res" id="tel_res" type="text" maxlength="7" style="margin: 0px 0px 0px 5px;" value="<%=datos.get("tel_residencia")%>">
                                            </td>
                                        </tr>
                                        <tr>
    ...
    function ver(){
        var Pais = document.getElementById("pais_res").value;
        
        if(Pais === 'COL'){
            
            $('#custom-tag').html('<select class="inputlargo" name="ciudad_res" id="ciudad_res"><%for (HashMap ciudad : ciudades) {String nomCiudad = (String) ciudad.get("nom_ciu");%><option value="<%=ciudad.get("cod_dane")%>"<%=nomCiudad.equalsIgnoreCase((String) datos.get("ciudad_residencia"))?" selected":""%>><%=nomCiudad%></option><%}%></select>');
            
        }else{
            
             $('#custom-tag').html('<input class="inputlargo" name="ciudad_res"  type="text" maxlength="50" value="<%=datos.get("ciudad_residencia")%>" id="ciudad_res">');
        }
    }
