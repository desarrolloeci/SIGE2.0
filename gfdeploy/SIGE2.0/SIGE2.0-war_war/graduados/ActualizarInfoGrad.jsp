...
<html>
    ...
    <body onload="actTabExpEgre(<%=doc_grad%>); ver();">
                            ...
                            <td valign="top" height="500" class="textocom" style="box-shadow:-5px 5px 5px 5px rgba(0,0,0,0.1); padding: 10px 20px;">
                                        <div align="center" id="ActDatos" style="display:inline">
                                            <table width="99%">
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                      <div align="center"><input type="submit" class="button_azul" value="Actualizar" name="ActdatosEgre" onclick="ActualizarDatEgre(<%=doc_grad%>);"/></div>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
    ...
    function ver(){
        ...
        if(Pais === 'COL'){
            ...
            $('#custom-tag').html('<select class="inputlargo" id="ciudad_res"><%for (HashMap ciudad : ciudades) {String nomCiudad = (String) ciudad.get("nom_ciu");%><option value="<%=ciudad.get("cod_dane")%>"<%=nomCiudad.equalsIgnoreCase((String) datos.get("ciudad_residencia"))?" selected":""%>><%=nomCiudad%></option><%}%></select>');
            
        }else{
            
             $('#custom-tag').html('<input class="inputlargo" type="text" maxlength="50" value="<%=datos.get("ciudad_residencia")%>" id="ciudad_res">');
        }
    }
