 ...
 * generated in the com.oracle.xmlns.enterprise.tools.schemas.ec_ib_int_p_srch_req_msg package. 
...
public class ObjectFactory {
    ...
    private final static QName _ECIBINTPSRCHREQMSG_QNAME = new QName("http://xmlns.oracle.com/Enterprise/Tools/schemas/EC_IB_INT_P_SRCH_REQ_MSG.V1", "EC_IB_INT_P_SRCH_REQ_MSG");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.oracle.xmlns.enterprise.tools.schemas.ec_ib_int_p_srch_req_msg
     * 
     */
    ...
    /**
     * Create an instance of {@link ECIBINTPSRCHREQMSGTypeShape }
     * 
     */
    public ECIBINTPSRCHREQMSGTypeShape createECIBINTPSRCHREQMSGTypeShape() {
        return new ECIBINTPSRCHREQMSGTypeShape();
    }
    ...
    /**
     * Create an instance of {@link FieldTypesECIBINTPSRCHTypeShape }
     * 
     */
    public FieldTypesECIBINTPSRCHTypeShape createFieldTypesECIBINTPSRCHTypeShape() {
        return new FieldTypesECIBINTPSRCHTypeShape();
    }
    ...
    /**
     * Create an instance of {@link ECIBINTPSRCHMsgDataRecordTypeShape }
     * 
     */
    public ECIBINTPSRCHMsgDataRecordTypeShape createECIBINTPSRCHMsgDataRecordTypeShape() {
        return new ECIBINTPSRCHMsgDataRecordTypeShape();
    }
    ...
    /**
     * Create an instance of {@link NAMETypeShape }
     * 
     */
    public NAMETypeShape createNAMETypeShape() {
        return new NAMETypeShape();
    }
    ...
    /**
     * Create an instance of {@link JAXBElement }{@code <}{@link ECIBINTPSRCHREQMSGTypeShape }{@code >}}
     * 
     */
    @XmlElementDecl(namespace = "http://xmlns.oracle.com/Enterprise/Tools/schemas/EC_IB_INT_P_SRCH_REQ_MSG.V1", name = "EC_IB_INT_P_SRCH_REQ_MSG")
    public JAXBElement<ECIBINTPSRCHREQMSGTypeShape> createECIBINTPSRCHREQMSG(ECIBINTPSRCHREQMSGTypeShape value) {
        return new JAXBElement<ECIBINTPSRCHREQMSGTypeShape>(_ECIBINTPSRCHREQMSG_QNAME, ECIBINTPSRCHREQMSGTypeShape.class, null, value);
    }
