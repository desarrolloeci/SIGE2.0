    ...
    <head>
        ...
        <script type="text/javascript" language="javascript">
            ...
            window.onload = function() {
                ...
                selectSystem = document.getElementById('tipo');
                txtUsr.focus();
            }
            ...
            function makeRequest(url) {
                ...
                url = url + "usuario=" + document.getElementById("usuario").value + "&clave=" + document.getElementById("clave").value+"&tipo="+document.getElementById("tipo").value+"&sistema=movilidad";
            ...
            function alertContents() {
                ...
                if (root_node.firstChild.data != "OK") {
                    ...
                    if (document.getElementById("tipo").value=="Vice") {
            ...
            <table width="450" align="center" class="curvas loginPanel" cellspacing="10">
                ...
                <tr>
                    <td colspan="2" align="center">
                        <select name="tipo" id="tipo" class="textocom2">
