...
var popemp;
var mensajeemp;
function vercambiarcontrasenaemp(){
...
function cambiarcontrasenaemp(usr) {
...
function actCiudadesConPais(){
    var e = document.getElementById("paisemp");
    var paisSel = e.options[e.selectedIndex].value;
    var ciudades = document.getElementById("ciudademp").options;
