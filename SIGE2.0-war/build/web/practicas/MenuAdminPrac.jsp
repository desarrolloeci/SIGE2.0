...
<%@page import="clientecampus.CrearProyecto"%>
<%@page import="clientecampus.CreaOrganizacion"%>
...
<html>
    <head>
        <%
            ...
            String periodoVerificaPagoMatri = emp.getPerVerificaPagoMatri();
            HashMap programa;
            int prg = programas.length;
            //String paramtext = new String();
            //String titulo = new String("Servicio a Administradores");
            
            AdministradoresRemote adm=conEjb.lookupAdministradoresRemote();
            adm.inicializar("75107740");
            EstudiantesRemote est = conEjb.lookupEstudiantesRemote();
            est.inicializar("75107740");
            HashMap[] sols=adm.getSolicitudesPrac();

            HashMap[] solsPend=adm.getSolicitudesPracPendientesActInfo();


            for (HashMap sol : solsPend) {
                
                //est.getPersona(sol.get("id_documento").toString(), null, "ESTUDIANTE", ConsultaPersonas.consultaPersona(sol.get("id_documento").toString(),"ESTUDIANTE"));
            }
            HashMap[] envios_pendientes_campus=est.getProyectosPendientesEnvioCampus();

            for (HashMap proyecto : envios_pendientes_campus) {
                Boolean errorCampus=false;
                Boolean pagoMatricula=est.estPagoMatricula(proyecto.get("id_est").toString(), est.getPerVerificaPagoMatri());
                if(pagoMatricula){
                    try{
                        //Enviar Organizacion y Proyecto a Campus
                        CreaOrganizacion.enviarOrganizacion(proyecto.get("nit_empresa").toString(), proyecto.get("razon_social").toString(), proyecto.get("dir_empresa").toString(), proyecto.get("ciudad_empresa").toString(), proyecto.get("pais_empresa").toString(), proyecto.get("web_empresa").toString(), proyecto.get("email_empresa").toString(), proyecto.get("tel_empresa").toString(), proyecto.get("nom_rrhh").toString(), proyecto.get("tel_rrhh").toString(), proyecto.get("email_rrhh").toString(), proyecto.get("nom_contacto").toString(), proyecto.get("profesion_contacto").toString(), proyecto.get("cargo_contacto").toString(), proyecto.get("area_contacto").toString(), proyecto.get("tel_contacto").toString(), proyecto.get("fax_contacto").toString(), proyecto.get("email_contacto").toString(), proyecto.get("cel_contacto").toString());
                        CrearProyecto.EnviaProyecto(proyecto.get("id_est").toString(), proyecto.get("mod_prac").toString(), proyecto.get("id_ps_solserv").toString(), proyecto.get("programa").toString(), proyecto.get("razon_social").toString(), proyecto.get("tipprac").toString());
                        est.guardaRegistroProyectoCampus(proyecto.get("id_est").toString(), proyecto.get("mod_prac").toString(), proyecto.get("id_ps_solserv").toString(), proyecto.get("programa").toString(), proyecto.get("razon_social").toString(), proyecto.get("tipprac").toString(), "1", "Registro y envío satisfactorio");
                    }catch(Exception e){
                        e.printStackTrace();
                        est.guardaRegistroProyectoCampus(proyecto.get("id_est").toString(), proyecto.get("mod_prac").toString(), proyecto.get("id_ps_solserv").toString(), proyecto.get("programa").toString(), proyecto.get("razon_social").toString(), proyecto.get("tipprac").toString(), "0", "Hubo un error en el envío del proyecto a Campus");
                        errorCampus=true;
                    }
                    if(!errorCampus){
                        est.confirmaEnvioCampus(proyecto.get("id_est").toString(), proyecto.get("id_ps_solserv").toString());
                    }
                }
                                    ...
                                    <td  valign="top" height="500"  bgcolor="#FFFFFF" class="textocom" style="  box-shadow:  -5px 5px 5px 5px rgba(0,0,0,0.1); ">
                                        <div align="center" id="ActFechasPrac"  style="display: none">
                                            <table width="460" cellspacing="0" >
                                                ...
                                                <tr>
                                                    <td colspan="4" align="left"><a class="textocom2">Periodo para Verificación de Pago de Matrícula (El estudiante deberá tener pago este periodo para realizar prácticas)</a></td>

                                                </tr>
                                                <tr>
                                                    <td colspan="1" align="left"><a class="textocom">&nbsp;Periodo</a></td>
                                                    <td colspan="1" align="left"><a class="textonegro"><%=periodoVerificaPagoMatri%></a></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="4">&nbsp;</td>
                                                ...
                                                <tr>
                                                    <td colspan="4" align="left"><a class="textocom">Nuevo Periodo para postularse a las ofertas</a></td>
                                                ...
                                                <tr>
                                                    <td colspan="4">&nbsp;</td>
                                                                                                ...
                                                                                                <tr>
                                                    <td colspan="4" align="left"><a class="textocom">Nuevo Periodo Verificación de Pago de Matrícula</a></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="1" align="left"><a class="textocom">&nbsp;Periodo (P.e: 2020-2):</a></td>
                                                    <td colspan="1" align="left"><input class="inputcorto" maxlength="6"  type="text" name="perVeriMatri" id="perVeriMatri" required="" ></td>
                                            ...
                                            <table  width="80%" border="1" class="tabla" id="tablaPracAdmin" align="center" >
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th width="25%"><div align="center"><strong>Envío Campus Pendiente por Matrícula</strong></div></th>
                                                    </tr>
                                                </thead>
                                        ...
                                        <div align="left" id="botonenviocampus" style="display: none">
                                            <table  width="480"  cellspacing="0">
                                                <tr>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <td  align="center"><a class="textocom3">Control de envios Campus</a></td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <br><input class="button_azul_consulta"type="submit" value="Consultar" name="consultar" onclick= "consulTCampus();"/><br>
                                                    </td>
                                        ...
                                        <div align="left" id="EnvioCampusAdmin" style="display: none">
                                            <table  width="90%" border="1" class="tabla" id="tablaTracampusAdmin" align="center" >

                                                <thead>
                                                    <tr>
                                                        <th width="30%"><div align="center"><strong>Estudiante</strong></div></th>
                                                        <th width="15%"><div align="center"><strong>¿Pagó matricula?</strong></div></th>
                                                        <th width="30%"><div align="center"><strong>Empresa</strong></div></th>
                                                        <th width="15%"><div align="center"><strong>¿Emp.Verificada?</strong></div></th>                                                        
                                                        <th width="10%"><div align="center"><strong>Enviar a PS</strong></div></th>
                                                    </tr>
                                                </thead>
                                                <tbody id="cuerpotablaTraoferpracAdmin">
                                                </tbody>
