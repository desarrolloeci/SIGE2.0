...
<html>
    <head>
        <%
            ...
            String per_prac = emp.getPerVerificaPagoMatri();
            String doc_est = (String) datos.get("doc_est");
            
            Boolean pago_matri = emp.estPagoMatricula(doc_est, per_prac);
        ...
        <jsp:include page="encabezado_prac"></jsp:include>
            <div align="center">
                ...
                <table>
                    ...
                    <tr class="textocom" >
                        <td align="left"><strong>Estado pago matrícula <%=per_prac%>:</strong></td>
                        <td align="left"><%=(pago_matri)?"Pago":"No Pago"%></td>
                    </tr>
                                <tr>
                                    <td width="20%">&nbsp;</td>
                                    <td width="80%">&nbsp;</td>
