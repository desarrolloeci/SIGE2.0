<%-- 
    Document   : HojadevidaGradEmp
    Created on : 20/04/2016, 04:01:51 PM
...
<html>
    <head>
        <%
            ...
            doc_grad = request.getParameter("ref");
            ...
            HashMap estado_apli = emp.EstadoActApliGradEmp(id_apli);
    ...
    <body background="imagenes/fondo.gif">
        ...
        <table width="800" align="center" class="curvas loginPanel" cellspacing="0" style="padding: 42px 10px;">
            <tr>
                <td colspan="2">
                    <table style="width: 80%; border: 1px solid #E0E0E0; border-radius: 5px; margin: 0px auto; background: #F7F7F7;">
                        ...
                        <tr>
                            ...
                            <td colspan="2" class="texto_gris">
                                Por favor seleccione el estado en el que se encuentra este postulante
                            </td>
                        </tr>
                        <tr>
                            <td colspan="1"></td>
                            <td colspan="1" align="left">
                                <select name="estadoapligrad" id="estadoapligrad" style="width: 80%;">
                            ...
                            <td colspan="1" align="left">
                                <input type="submit" value="Clasificar" name="consultar" onclick="Actestadoapligrad(<%=id_apli%>);"/>
                            </td>
                        </tr>
                        <tr style="height: 1em;"></tr>
                    </table>
