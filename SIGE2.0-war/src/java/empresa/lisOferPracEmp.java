 ...
 */
public class lisOferPracEmp extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet lisOferPracEmp</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet lisOferPracEmp at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
        } finally { 
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            HashMap[] items = bd.getListaOferPracEmp(idemp,consulta);
            HashMap item;
