 ...
 */
    public class ActDatEmpresa extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ActDatEmpresa</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ActDatEmpresa at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
        } finally { 
    ...
    throws ServletException, IOException {
       try {
           ...
           //'nomrrhh','telrrhh','emailrrhh'
            res = "<resultado>";
            ret= bd.ActDatempresa(nit,rasocial,paisemp,ciudademp,diremp,webemp,emailemp,telemp,nomconte,cargoconte,areaconte,
        ...
        //Enviar Respuesta
            ...
            Logger.getLogger(ActDatEmpresa.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
