 ...
 */
public class EnviarPlandeEstudio extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet EnviarPlandeEstudio</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet EnviarPlandeEstudio at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
        } finally { 
    ...
    throws ServletException, IOException {
        try
         {
           ...
           clave = "enviado";
            res = "<resultado>";
            ret= bd.Actualizarestadoplan(idsol, clave);
       ...
       if (ret > 0) {
            ...
            ban=em.enviar(idsol,"solplan_dec");
            if(ban==1){
              res = res + "<valor>Operación Exitosa</valor>";
            }
           else{
                res = res + "<valor>El plan de estudio ha sido registrado pero no se ha podido enviar el email de notificacion al decano</valor>";
           }
        } else {
        ...
        //response.sendRedirect("EstMov" );
            ...
            Logger.getLogger(EnviarPlandeEstudio.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
