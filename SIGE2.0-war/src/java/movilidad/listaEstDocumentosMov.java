 ...
 */
public class listaEstDocumentosMov extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet listaEstDocumentosMov</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet listaEstDocumentosMov at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
        } finally { 
        ...
        try
         {
           ...
           progmov = request.getParameter("progmov");
            ...
            HashMap[] sols=adm.getSolicitudesMov();
            for (HashMap sol : sols) {
                ...
                if(!bd.getInfoEstCache(sol.get("id_est").toString())){
                    bd.getPersona(sol.get("id_est").toString(), null, "ESTUDIANTE", ConsultaPersonas.consultaPersona(sol.get("id_est").toString(), "ESTUDIANTE"));
                }
            }

           
           HashMap[] items = bd.getListaEstDoc(res,iddpto,progmov);
           HashMap item;
            ...
            Logger.getLogger(listaEstDocumentosMov.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
