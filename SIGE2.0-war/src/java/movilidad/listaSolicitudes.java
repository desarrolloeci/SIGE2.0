 ...
 */
public class listaSolicitudes extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet listaSolicitudes</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet listaSolicitudes at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
        } finally { 
        ...
        try
         {
           ...
           HashMap[] items = bd.getListaSolicitudes(res,iddpto,progmov);
           HashMap item;
