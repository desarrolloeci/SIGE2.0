 ...
 */
public class lisAplicantesMov2 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet lisAplicantesMov2</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet lisAplicantesMov2 at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
        } finally { 
        ...
        try
         {
           ...
           HashMap[] items = bd.getListaApliMov(res,iddpto,progmov);
           HashMap item;
            ...
            for (i = 0; i < t; i++) {
                item = items[i];
                res = res + "<aplicante>"  + "<nombre>" + item.get("nom_est") + "</nombre>" + "<progmov>" + 
                        item.get("prog_mov") + "</progmov>" + "<estado>" + item.get("men_admin") + "</estado>" +
                        "<id_solicitud>" + item.get("id_solicitud") + "</id_solicitud>"+ "</aplicante>";
            }
            ...
            Logger.getLogger(lisAplicantesMov2.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
