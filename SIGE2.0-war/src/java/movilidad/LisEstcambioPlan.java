 ...
 */
public class LisEstcambioPlan extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet LisEstcambioPlan</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet LisEstcambioPlan at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
        } finally { 
    ...
    throws ServletException, IOException {
         try
         {
           ...
           HashMap[] items = bd.getListaEstcambioPlan(res,iddpto,progmov);
           HashMap item;
            ...
            Logger.getLogger(LisEstcambioPlan.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
