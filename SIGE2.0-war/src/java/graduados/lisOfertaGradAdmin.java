 ...
 */
public class lisOfertaGradAdmin extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet lisOfertaGradAdmin</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet lisOfertaGradAdmin at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
        } finally { 
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        try {
            ...
            programagradAdmin= request.getParameter("programagradAdmin");
            HashMap[] items = bd.getListaofergradAdmin(programagradAdmin);
            HashMap item;
