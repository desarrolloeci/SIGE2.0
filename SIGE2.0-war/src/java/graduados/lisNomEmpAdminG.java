 ...
 */
public class lisNomEmpAdminG extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet lisNomEmpAdminG</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet lisNomEmpAdminG at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
        } finally { 
...
//'nombreEmpAdminG','nitEmpAdminG'
           ...
           nombre = request.getParameter("nombreEmpAdminG");
           nit = request.getParameter("nitEmpAdminG");
...
//id_empresa, razon_social, nit
            ...
            Logger.getLogger(lisNomEmpAdminG.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
