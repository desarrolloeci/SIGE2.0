 ...
 */
public class lisLosClasificados extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet lisLosClasificados</title>");  
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet lisLosClasificados at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
            */
        } finally { 
    ...
    throws ServletException, IOException {
         try
         {
           ...
           HashMap[] items = bd.getLosclasificados();
           HashMap item;
...
"</cargoegre>"+ "<docgrad>" + docgrad + "</docgrad>" +"</experiencia></listaexperiencias>";*/
            ...
            for (i = 0; i < t; i++) {
                ...
                res = res +"<clasificado>"+"<id>" + item.get("id")+ "</id>"+"<titulo>" + item.get("titulo")+ "</titulo>" + "<id_documento>"
                     + item.get("id_documento")+"</id_documento>" + "<estado_clas>" + item.get("estado_clas") + "</estado_clas>"+
            ...
            Logger.getLogger(lisLosClasificados.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
