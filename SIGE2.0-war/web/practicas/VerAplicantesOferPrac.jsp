<%-- 
    Document   : VerAplicantesOferPrac
    Created on : 21/01/2013, 11:25:37 AM
...
<html>
    <head>
        <%
            ...
            HashMap[] aplicantes=emp.getAplicantesOferPracEmp(idoferta);
            //id_aplicacion
            HashMap aplicante;
            HashMap estado;
            ...
            <td align="center" valign="top" width="80%" height="500">
                <table>
                    ...
                    <tr>
                        ...
                        <td><a class="textocom"><%=datosoferta.get("salario_oferta")%> COL$</a></td>
                    </tr>
                    <tr>
                         <td colspan="2">_________________________________________________________________________</td>
                    </tr>
