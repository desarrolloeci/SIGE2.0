    ...
    <head>
        ...
        <script type="text/javascript" language="javascript">
            ...
            function checkSelection() {
                ...
                var selOpt = document.getElementById('sistema').options;
                if (userVal == 'ori') {
            ...
            function makeRequest(url) {
                ...
                url = url + "usuario=" + document.getElementById("usuario").value + "&clave=" + encodeURIComponent(document.getElementById("clave").value)+"&tipo=Admin&sistema="+document.getElementById("sistema").value;
            ...
            function alertContents() {
                ...
                if (root_node.firstChild.data != "OK") {
                    ...
                    if (document.getElementById("sistema").value=="movilidad") {
                        ...
                        if (document.getElementById("sistema").value=="practicas") {
            ...
            <table width="450" align="center" class="curvas loginPanel" cellspacing="10">
                ...
                <tr>
                    <td colspan="2" align="center">
                        <select name="sistema" id="sistema" class="textocom2">
                ...
                <tr>
                    <td colspan="2" align="center">
                        <input id="btnLogIn" class="button_rojo" type="submit" value="Conectar" />
                    </td>
                    <tr>
                        <td colspan="3" align="center" class="textocom">Se recomienda utilizar google chrome como navegador prederteminado.</td>
                    </tr>
                </tr>
                <tr>
                    <td colspan="2" align="center">                             
