<%-- 
    Document   : InformesAdminGrad
    Created on : 20/11/2012, 01:04:57 PM
...
background-size: 100% 100%;
    ...
    <body >
        ...
        <table width="640" border="0" align="center" cellspacing="0">
            <tr class="textocom">
                <td width="200" height="20"><div align="center" class="menuprueba2"><font color="#FFFFFF"><strong>Opciones</strong></font></div></td>
                                       ...
                                       <table  width="480"  cellspacing="0">
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <input class="inputsupercorto"  type="checkbox" name="BoxReporteGrad" value=" (select top 1 nom_pais from uge.paises where cod_iso=pais_residencia) as pais_residencia" >País residencia<br>
                                                    <input class="inputsupercorto"  type="checkbox" name="BoxReporteGrad" value=" (select TOP 1 nom_ciudad from uge.ciudades where cod_dane=ciudad_residencia) as ciudad_residencia" >Ciudad residencia<br>
                                                    <input class="inputsupercorto"  type="checkbox" name="BoxReporteGrad" value="nomcortoes" >Nombre para Comunicaciones    <br>
