<%-- 
    Document   : reporteIdioG
    Created on : 23/11/2012, 10:33:59 AM
    ...
    inicio.conectaEJB conEjb = new inicio.conectaEJB();
     ...
     String fechaout = new String ();
      String nomdato = new String ();
       ...
       HashMap[] infos= Admin.getReporteIdioG(programa, fechain, fechaout,datos);
       HashMap info;
...
%>
    ...
    <body >
        ...
        <table width="450"  align="center" border="2"  cellspacing="0" bordercolor="#000000">
            <tr> <td align="center" border="1"  bgcolor="#EEEBFC" style="font-size: 12pt; color:#000000 " > <i>INFORME DE IDIOMAS</i> </td></tr><br/>
