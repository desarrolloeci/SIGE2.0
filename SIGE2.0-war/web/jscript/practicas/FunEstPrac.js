...
function ActualizarDatPrac() {
    ...
    if(!isDiligenciado(['tel2prac','celprac','email2prac','perfilprac','refprac','exvprac'],['Telefono 2','Numero de Celular',
        'Email 2','Perfil Profesional','Referencias','Expectativas'])) {
            return false;
    }
