...
function validaProgPais(){
    var fechain=document.getElementById("fechain").value;
    var fechaout=document.getElementById("fechaout").value;
    
    if(fechain.split("/").length===2 && fechaout.split("/").length===2){
        if((Number(fechain.split("/")[0])<1)||(Number(fechain.split("/")[0])>12)||(Number(fechain.split("/")[1])<2020)||(Number(fechain.split("/")[1])>9999)||(Number(fechaout.split("/")[0])<1)||(Number(fechaout.split("/")[0])>12)||(Number(fechaout.split("/")[1])<2020)||(Number(fechaout.split("/")[1])>9999)){
